...
## Project Structure
    ...
    ├── ideapros_llc_sayann_32126  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_sayann_32126`
...
2. Clone this repo and `cd ideapros_llc_sayann_32126`
